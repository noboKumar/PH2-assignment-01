...
* future এ extend বা merge করতে, interface ব্যবহার করা ভালো।
...
* union, tuple, primitive type define করতে type ব্যবহার ভালো।
...
* সাধারণত ফাংশন যা সবসময় error দেয় বা অসীম loop এ থাকে।
